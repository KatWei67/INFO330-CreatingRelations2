CREATE TABLE pokemon( height_m REAL, hp INTEGER, name TEXT, percentage_male REAL, pokedex_number INTEGER,  weight_kg REAL, speed INTEGER, generation INTEGER, is_legendary INTEGER);
...
INSERT INTO pokemon(height_m, hp, name, percentage_male, pokedex_number,  weight_kg, speed, generation, is_legendary) 
SELECT height_m, hp, name, percentage_male, pokedex_number,  weight_kg, speed, generation, is_legendary FROM imported_pokemon_data;
...
INSERT INTO attack(pokedex_number, attack, sp_attack) SELECT pokedex_number, attack, sp_attack FROM imported_pokemon_data;

INSERT INTO defense(pokedex_number, defense, sp_defense) SELECT pokedex_number, defense, sp_defense FROM imported_pokemon_data;

INSERT INTO base(pokedex_number, base_egg_steps, base_happiness, base_total) SELECT pokedex_number, base_egg_steps, base_happiness, base_total FROM imported_pokemon_data;

INSERT INTO capture(pokedex_number, capture_rate, experience_growth) SELECT pokedex_number, capture_rate, experience_growth FROM imported_pokemon_data;
